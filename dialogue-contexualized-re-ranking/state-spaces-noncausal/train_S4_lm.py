...
@hydra.main(config_path="configs", config_name="wiki_noncausal_lm_config.yaml")
def main(config: OmegaConf):
    ...
    train_dataloader = DataLoader(train_data,batch_size=batch_size,collate_fn=collator)
    eval_dataloader = DataLoader(eval_data,batch_size=batch_size,collate_fn=collator)
    ...
    '''
    Intializing S4 model
    HuggingFace accelerate is used to manage distributed training
    '''
