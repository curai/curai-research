...
def parse_args():
    ...
    parser.add_argument('--dataset_artifact', default='curai/history_taking_reranking/reranking_data:v0', 
                        type=str,help='the url to the dataset artifact')
    parser.add_argument('--eval_pretrained_model_artifact',default=None,type=str)
    parser.add_argument('--pretrained_model_artifact',default='curai/history_taking_reranking/checkpoints:v286',type=str)
    ...
    parser.add_argument('--saving_step',default=400,type=int)
...
if __name__ == "__main__":
    ...
    if args.pretrained_model_artifact is not None:
        print('Loading pretrained mdoel artifact...')
