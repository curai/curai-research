...
#     violation_path = "multi-rule-guardrail/sgd/prompts/flights_violation.jinja",
#     rules_path="multi-rule-guardrail/sgd/prompts/rules.csv",
#     scenario_csv_path="multi-rule-guardrail/sgd/output/flight_scenarios.csv",
...
# generate_AME_nonviolations("multi-rule-guardrail/sgd/output/convos_violations_flights_3-23.csv",
#     "multi-rule-guardrail/sgd/prompts/ame_violation_flights.jinja",
#     "flights",
...
generate_nonviolations(55, "multi-rule-guardrail/sgd/prompts/nonviolation_flights.jinja", "multi-rule-guardrail/sgd/output")